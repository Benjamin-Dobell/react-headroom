...
var Headroom = function (_Component) {
  ...
  function Headroom(props) {
    ...
    _this.unpin = function () {
      ...
      _this.setState({
        translateY: '-100%',
        className: _this.classes.main + ' ' + _this.classes.unpinned
      }, function () {
        setTimeout(function () {
    ...
    _this.pin = function () {
      ...
      _this.setState({
        translateY: 0,
        className: _this.classes.main + ' ' + _this.classes.pinned,
        state: 'pinned'
      });
    };
    ...
    _this.unfix = function () {
      ...
      _this.setState({
        translateY: 0,
        className: _this.classes.main + ' ' + _this.classes.unfixed,
        state: 'unfixed'
      });
    };
    ...
    _this.scrollTicking = false;
    _this.resizeTicking = false;
    _this.classes = Object.assign({}, defaultClasses, props.classes);
    _this.state = {
      state: 'unfixed',
      translateY: 0,
      className: _this.classes.main + ' ' + _this.classes.unfixed
